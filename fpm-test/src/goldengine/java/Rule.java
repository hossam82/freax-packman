...
public class Rule implements SymbolTypeConstants
{
	 ...
	 * 
	 * @param index
	 *            The index of the symbol wanted.
	 * @return The symbol at the specified index.
	 ***************************************************************/
	public Symbol getSymbols(int index)
	{
		if ((index >= 0) & (index < pRuleSymbols.count())) { return pRuleSymbols.getMember(index); }
...
/***************************************************************
	 ...
	 * the rule, It does this by concatenating all the Symbols in the Symbol
	 * list.
	 * 
	...
	public boolean containsOneNonTerminal()
	{
		...
		{
			if (pRuleSymbols.getMember(0).getKind() == symbolTypeNonterminal) { return true; }
		}
	...
	/***************************************************************
	 * isEqual #ver1.1#
	 * This method will check equality of two Rules - this and the one passed
	 * in.
	 * 
	 * @param secondRule
	 *            The rule to check against this one.
	...
	public boolean isEqual(Rule secondRule)
	{
		...
		if ((pRuleSymbols.count() == secondRule.getSymbolCount()) & (pRuleNonterminal.isEqual(secondRule.getRuleNonTerminal())))
		{
			equal = true;
