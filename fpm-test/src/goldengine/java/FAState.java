...
{
	private Vector<FAEdge> edges = new Vector<FAEdge>();
	 ...
	 * 
	 * @param chars
	 *            The set of characters associated with the edge to
	 *            be created.
	 * @param target
	 *            The target index in this state.
	 ***************************************************************/
	public void addEdge(String chars, int target)
	{
		...
		else
		{
			...
			{
				FAEdge tmpEE = edges.elementAt(index);
	 ...
	 * 
	 * @param index
	 *            The index of the edge that will be returned.
	 * @return The FAEdge at the specified index.
	 ***************************************************************/
	public FAEdge edge(int index)
	{
		if ((index >= 0) & (index < edges.size())) { return edges.elementAt(index); }
