 ...
 * Description: A holding class for Symbols, with special methods needed that a
 * Vector
 * can not fulfil.<br>
 * ----------------------------------------------------------------------------
 * ---------------<br>
...
{
	private Vector<Symbol> memberList = new Vector<Symbol>();
	...
	{
		if ((index >= 0) & (index < memberCount)) { return memberList.elementAt(index); }
	 ...
	 * 
	 * @param name
	 *            The name of the Symbol wanted in the list.
	 * @return The Symbol with the same name of that passed in.
	 ***************************************************************/
	public Symbol getMember(String name)
	{
		Enumeration<Symbol> _enum = memberList.elements();
		while (_enum.hasMoreElements())
		{
			Symbol tmp = _enum.nextElement();
	 ...
	 * 
	 * @param index
	 *            The index to set the Symbol to.
	 * @param obj
	 *            The Symbol to place in the SymbolList.
	 ***************************************************************/
