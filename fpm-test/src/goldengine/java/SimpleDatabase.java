 ...
 * Description: A class written to open a binary cgt file (written in VB), and
 * read its
...
public class SimpleDatabase implements EntryContentConstants
{
	...
	private Vector<Object> entryList = null;
	 ...
	 * 
	 * @param fileName
	 *            the absolute pathname of the file to read.
	 ...
	 *         not.
	 * @throws ParserException
	 *             If there was a problem with reading the
	 *             stream.
	 ***************************************************************/
	 ...
	 * @throws ParserException
	 *             If there was some problem with the stream.
	 ***************************************************************/
	...
	private void readEntry() throws IOException
	{
		...
		switch (t1)
		{
			...
			case entryContentInteger:
				...
				if ((b1 < 0) & (b2 == 0))
				{
					String tmpStr = Integer.toBinaryString(b1);
				...
				else
				{
					if (b1 < 0)
					{
						String tmpStr = Integer.toBinaryString(b2);
						binar = tmpStr;
						tmpStr = Integer.toBinaryString(b1);
						binar += tmpStr.substring(tmpStr.length() - 8);
					}
					else
					{
						if (b2 == 0)
						{
							binar = Integer.toBinaryString(b1);
						}
						else
						{
							binar = Integer.toBinaryString(b1);
							...
							binar = Integer.toBinaryString(b2) + binar;
						}
					}
				}
