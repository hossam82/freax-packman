 ...
 * Description: A holding class for VariableTypes, with special methods needed
 * that a
...
{
	private Vector<VariableType> memberList = new Vector<VariableType>();
	 ...
	 * @param comment
	 *            Any associated comment for the variable.
	...
	public boolean add(String name, String value, String comment)
	{
		...
		{
			VariableType varType = memberList.elementAt(n);
	...
	{
		Enumeration<VariableType> enumA = memberList.elements();
		while (enumA.hasMoreElements())
		{
			VariableType varType = enumA.nextElement();
			varType.setName("");
		}
	}
	...
	public String name(int index)
	{
		...
		{
			VariableType varType = memberList.elementAt(index);
	 ...
	 * 
	 * @param name
	 *            The name of the variable to set its value.
	 * @param value
	 ...
	 * 
	 * @param name
	 *            The name of the variable wanted.
	 ...
	 * 
	 * @param name
	 *            The name of the variable to get its index.
