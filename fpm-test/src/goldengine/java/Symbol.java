...
public class Symbol implements SymbolTypeConstants
{
	...
	/***************************************************************
	 * isEqual #ver1.1#
	 * This method will check equality of two Symbols - this and the one passed
	 * in.
	 * 
	 * @param other
	 *            The symbol to check against this one.
	 * @return True if it is equal, false if not.
	 ***************************************************************/
	public boolean isEqual(Symbol other)
	{
		if ((pName.equals(other.getName())) & (pKind == other.getKind())) { return true; }
