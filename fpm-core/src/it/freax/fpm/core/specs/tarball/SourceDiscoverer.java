package it.freax.fpm.core.specs.tarball;

import it.freax.fpm.core.archives.ArchiveReader;
import it.freax.fpm.core.specs.DummySpec;
import it.freax.fpm.core.specs.TarballSpec;
import it.freax.fpm.core.specs.tarball.antlr.AntlrEngine;
import it.freax.fpm.core.specs.tarball.conf.*;
import it.freax.fpm.core.specs.tarball.dto.CompilationUnit;
import it.freax.fpm.core.specs.tarball.dto.SrcFile;
import it.freax.fpm.core.specs.tarball.dto.Treenode;
...
public class SourceDiscoverer
{
	...
	private void makeInstructionSet(Treenode tn, ArrayList<SrcFile> files)
	{
		...
		String delimiter = ExitCodeControlType.getDelimiter(genInfo.getExitCodeControl());
		...
		while (it.hasNext())
		{
			...
			{
				if (genInfo.getRootExec() == RootExecutionType.Sudo)
				{
					command.add(RootExecutionType.getPrivileges(RootExecutionType.Sudo));
				}
			}
