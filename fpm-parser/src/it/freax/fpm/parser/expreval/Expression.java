 ...
 * reversed)</DD>
 * <DT>pow</DT>
 * <DD>raise the preceding number to the power of the following number (this can
 * only raise to power of positive integers or zero)</DD>
 * <DT>int</DT>
...
public class Expression
{
	...
	{
		return rootOperation.eval(variables);
	}
